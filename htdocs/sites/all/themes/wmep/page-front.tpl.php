...
<?php } ?>
		...
		<div id="main">
			<div id="splash">
				...
				<div id="splash-main" class="slide"><?php print $hp_banner1; ?></div>
				<div id="splash-cfi-slide" class="slide"><?php print $hp_banner2; ?></div>
				<div id="splash-sci-slide" class="slide"><?php print $hp_banner3; ?></div>
				<div id="splash-atm-slide" class="slide"><?php print $hp_banner4; ?></div>
				<div id="splash-ge-slide" class="slide"><?php print $hp_banner5; ?></div>
				<div id="splash-eem-slide" class="slide"><?php print $hp_banner6; ?></div>
				<div id="splash-sppd-slide" class="slide"><?php print $hp_banner7; ?></div>

				<ul id="splash-nav">
				  <li id="splash-cfi"><a href="<?php  print $link2; ?>"><strong>Customer Focused</strong><br />Innovation</a></li>
				  <li id="splash-sci"><a href="<?php  print $link3; ?>"><strong>Systemic Continuous</strong><br />Improvement</a></li>
				  <li id="splash-atm"><a href="<?php  print $link4; ?>"><strong>Advanced Talent</strong><br />Management</a></li>
				  <li id="splash-ge"><a href="<?php   print $link5; ?>"><strong>Global</strong><br />Engagement</a></li>
				  <li id="splash-eem"><a href="<?php  print $link6; ?>"><strong>Extended Enterprise</strong><br />Management</a></li>
				  <li id="splash-sppd"><a href="<?php print $link7; ?>"><strong>Sustainable Products</strong><br />&amp; Process Development</a></li>
				</ul>
			</div>
	...
	<?php endif; ?>
				...
				<div id="banners">
					...
					<div id="banner-news"><a href="/news/newsletter/archive">Sign up for <strong>WMEP's monthly e-newsletter</strong> today!</a></div>
				</div>
