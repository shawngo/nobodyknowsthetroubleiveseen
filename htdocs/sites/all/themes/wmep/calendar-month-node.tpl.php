 ...
 */
$term_classes = '';
$termdata = explode('|', $node->node_vid);
foreach ($termdata as $term_instance) {
  $term_classes .= strtolower(str_replace(' ', '_', $term_instance)) .' ';
}
// remove node_vid so it isn't displayed
unset($fields['node_vid']);
?>
<div class="view-item view-item-<?php print $view->name ?> <?php print $term_classes; ?>">
