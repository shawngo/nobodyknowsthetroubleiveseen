// $Id: README.txt,v 1.13 2010/02/02 16:57:55 justphp Exp $
...
Login to your drupal admin panel and browse to the manage modules page (/admin/build/modules), check the checkbox next to the Constant contact module and the click the save configuration button, the module is under a sub heading called "Mail".

The module is now enabled but requires configuring before it can work.

Visit the "Constant Contact" settings page to complete the setup (/admin/settings/constant_contact).

As a minimum you need to enter your constant contact account username and password.

Once that is done you can choose to display a form block or a checkbox or list seletion on the register page.

Check the drupal admin help section and comments for further guidance.
